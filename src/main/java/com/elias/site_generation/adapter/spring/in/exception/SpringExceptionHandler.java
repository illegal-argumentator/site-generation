...
import com.elias.site_generation.adapter.spring.in.exception.converter.ValidationErrorConverter;
...
public class SpringExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleUnexpectedExceptions(Exception e, HttpServletRequest request) {
