...
class SiteThemeGenerationAdapter implements SiteThemeGenerationPort {
    ...
    public String generate(Site site) {
        String sysPrompt = """
                Input: Create new css rewriting and old one using new random styles.
                Output: New css file without any additional text.
                Old file: %s
                """.formatted(css);
        String response =  aiService.generate(new AiRequest(sysPrompt, site.getContent()));
